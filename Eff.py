...
# ปุ่มบันทึกไฟล์ (แสดงเมื่อมีการอัปโหลดไฟล์ใหม่)
...
# ตรวจสอบแหล่งที่มาของข้อมูล (Data Source)
data_source = None
if uploaded_file is not None:
    ...
    st.sidebar.caption("📌 กำลังแสดงข้อมูลที่ล็อกไว้ในระบบ (data.xlsx)")
